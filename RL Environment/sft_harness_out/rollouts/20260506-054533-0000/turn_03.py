...
def flash_attention_forward_kernel(
    ...
    for block_n in range(tl.cdiv(N_CTX, BLOCK_N)):
        ...
        # q: [BLOCK_M, BLOCK_D], k: [BLOCK_N, BLOCK_D] -> s: [BLOCK_M, BLOCK_N]
...
def flash_attention_backward_kernel(
    ...
    for block_n in range(tl.cdiv(N_CTX, BLOCK_N)):
        ...
        # p: [BLOCK_M, BLOCK_N], do: [BLOCK_M, BLOCK_D] -> [BLOCK_N, BLOCK_D]
        ...
        # do: [BLOCK_M, BLOCK_D], v: [BLOCK_N, BLOCK_D] -> [BLOCK_M, BLOCK_N]
        ds = tl.dot(do, tl.trans(v))
        ...
        # p: [BLOCK_M, BLOCK_N], dp: [BLOCK_M, BLOCK_N] -> [BLOCK_N, BLOCK_D]
        dk_block = tl.dot(tl.trans(p), dp)
        ...
        # Compute dQ: dQ += dP @ K
        # dp: [BLOCK_M, BLOCK_N], k: [BLOCK_N, BLOCK_D] -> [BLOCK_M, BLOCK_D]
        dq = dq + tl.dot(dp, k)
